...
def calcular_fitness(individuo):
    ...
    #     if abs(individuo[i] - individuo[i+1]) % 2 != 0 and abs(individuo[i] - individuo[i+1])< 3:
    #         fitness += 1     

    # fitness = 0
    # for i in range(0,numero_genes-1):
    #     if (individuo[i] + individuo[i+1]) < 10 and abs(individuo[i] - individuo[i+1])< 4:
    #         fitness += 1     
    ...
    # fitness = 0
    # for i in range(0,numero_genes-1):
    #     if abs(individuo[i] - individuo[i+1])< 4:
    #         fitness += 1     
    return fitness
...
def generar_nuevos_individuos(mejores_individuos):
  ...
  #   if mejores_individuos[[numero_individuo-1][:4]] not in nuevos_individuos[[numero_individuo][4:]]: 
