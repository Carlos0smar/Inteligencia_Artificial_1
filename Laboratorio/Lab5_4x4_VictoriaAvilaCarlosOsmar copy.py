...
def wins(estado, player):
    ...
    * Dos diagonales [X X X] or [O O O]
    ...
    win_state = [
        ...
        [estado[0][3], estado[1][2], estado[2][1], estado[3][0]]
    ]
...
def minimax(estado, depth, player, alpha, beta):
    ...
    if player == COMPUTADOR:
        ...
        # best = [-1, -1, +infinity]
        # for cell_2 in empty_cells(estado):
        #     x, y = cell_2[0], cell_2[1]
        #     estado[x][y] = player
        #     estado_=estado
        #     if x > 0 :
        #         if estado_[x - 1][y] == player:
        #             movement.append(estado_)
        #     if x < 3:
        #         if estado_[x + 1][y] == player:
        #             movement.append(estado_)
        #     if y > 0:
        #         if estado_[x][y - 1] == player:
        #             movement.append(estado_)
        #     if y < 3:
        #         if estado_[x][y + 1] == player:
        #             movement.append(estado_)

        # for moved in movement:
        #     score = minimax(moved, depth - 1, -player, alpha, beta)
        #     estado[x][y] = 0
        #     score[0], score[1] = x, y
        #     if score[2] < best[2]:
        #         best = score
